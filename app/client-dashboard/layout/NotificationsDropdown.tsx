...
import { Bell, X, Check, Package, Heart, Gift, MessageCircle } from "lucide-react"
import {
  fetchNotifications,
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        <Bell size={18} />
        {unreadCount > 0 && (
          <span className="absolute -top-1 -right-1 h-4 w-4 bg-green-600 rounded-full ring-2 ring-white dark:ring-zinc-950 flex items-center justify-center text-[9px] font-bold text-white">
      ...
      {isOpen && (
        <div className="absolute right-0 top-10 w-80 md:w-96 bg-white dark:bg-zinc-950 border border-green-100 dark:border-zinc-800 rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200 z-50">
          {/* Header */}
          <div className="flex items-center justify-between px-4 py-3 border-b border-green-100 dark:border-zinc-800 bg-green-50/50 dark:bg-green-900/10">
          ...
          <div className="max-h-[400px] overflow-y-auto">
            {loading ? (
              ...
              <div className="divide-y divide-green-100 dark:divide-zinc-800">
                {notifications.map((notification) => (
                  <div
                    key={notification.id}
                    className={`p-4 hover:bg-green-50/50 dark:hover:bg-zinc-900/50 transition-colors relative group ${
          ...
          {/* Footer */}
          {notifications.length > 0 && (
            <div className="border-t border-green-100 dark:border-zinc-800 p-3 bg-green-50/50 dark:bg-green-900/10">
