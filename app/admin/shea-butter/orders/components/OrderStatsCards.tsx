...
export default function OrderStatsCards({ stats }: { stats: Stats }) {
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-md p-6 text-white">
      ...
      <div className="bg-gradient-to-br from-pink-500 to-pink-600 rounded-md p-6 text-white">
