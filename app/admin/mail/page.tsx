    ...
    <div className="max-w-7xl mx-auto p-4 md:p-8 space-y-8 animate-in fade-in duration-700">
      ...
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-6 bg-white dark:bg-zinc-950 border border-zinc-100 dark:border-zinc-800 rounded-[2rem] shadow-sm">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl md:text-2xl font-black uppercase tracking-tighter text-zinc-900 dark:text-zinc-100">
        ...
        <button
          ...
          className="w-full md:w-auto h-12 px-8 rounded bg-green-600 text-white font-black text-[10px] uppercase tracking-widest shadow-xl shadow-green-600/20 hover:bg-green-700 active:scale-95 transition-all flex items-center justify-center gap-2"
        >
      ...
      <nav className="flex overflow-x-auto no-scrollbar gap-2 -mx-4 px-4 md:mx-0 md:px-0">
        {[
          ...
          <button 
            key={t.id}
            onClick={() => setTab(t.id)} 
            className={`flex items-center gap-2 whitespace-nowrap px-6 py-3.5 rounded text-[10px] font-black uppercase tracking-widest transition-all ${
              tab === t.id 
